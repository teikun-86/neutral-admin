...
export const CreateFlightReservation = ({ refetchReservations = () => {} }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        await axios.post('/hajj-umrah/flights/reservations/store', transformed).then(res => {
            setLoading(false)
    ...
    return (
        <Modal id="createFlightReservationModal" size="lg" static>
            {
                loading && (
