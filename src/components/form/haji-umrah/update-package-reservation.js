...
export const UpdatePackageReservation = ({
    reservation,
    refetch,
    setReservation,
}) => {
    ...
    const handleSubmit = async (e) => {
        ...
        setErrors({})
        setMessage(null)
        await axios.post("/hajj-umrah/packages/reservations/update", {
            id: data.id,
    ...
    return (
        <Modal id="updatePackageReservationModal" size="lg" static>
            {
                loading && (
            ...
            <Modal.Header>
                <Modal.Title>Update Package Reservation</Modal.Title>
            </Modal.Header>
