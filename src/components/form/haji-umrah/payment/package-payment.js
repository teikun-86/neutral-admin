...
export const PackagePayment = ({ reservation, refetch, setReservation }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        await axios.post("/hajj-umrah/packages/reservations/add-payment", transformed).then(res => {
            setLoading(false)
    ...
    return (
        <Modal size="lg" id="addPackageReservationPaymentModal" static>
            {
                loading && (
