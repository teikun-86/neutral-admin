...
export const CreateFlight = ({ refetchFlights = () => {} }) => {
    ...
    const handleSubmit = async e => {
        ...
        await axios.post('/hajj-umrah/flights/store', transformed).then(res => {
            setModalState('')
            reset()
            refetchFlights()
            setLoading(false)
    ...
    return (
        <Modal id="createHajiUmrahFlightModal" static size="lg">
            {
                loading && (
            ...
            <Modal.Header>
                <h4 className="text-lg font-semibold text-gray-900 dark:text-white">Create Flight</h4>
            </Modal.Header>
                    ...
                    <div className="flex flex-wrap w-full">
                        ...
                        <div className="w-full lg:w-1/2 p-2">
                            <Combobox nullable value={data.program_type} className="w-full" onChange={(value) => {
                                ...
                                <Combobox.Input readOnly onChange={(e) => setQuery(e.target.value)} label="Program Type" showButton className="cursor-default" displayValue={(d) => `${d} Days`} />
                                <Combobox.Container>
                                    <Combobox.Options>
